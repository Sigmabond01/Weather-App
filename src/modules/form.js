...
function toggleLoadingAnimationForSubmitBtn(submitBtn, state) {
  if (state === "on") {
    submitBtn.style.background = "0% / cover url(./images/icons/loader.svg)";
    submitBtn.style.animation = "2s spin infinite";

    // Cleanup in case you switch to 'off'
    setTimeout(() => {
